...
| **RTO Excel** | `public/route-rationalization-kashmir/Kashmir_Route_Frequency_Plan_v3.3.5_RTO.xlsx` | Excel | - | Official RTO submission workbook |
...
- Headway is set by Priority Band: HP=15-20min, MP=25-35min, LP=45-60min
