...
// district boundaries.
// v3.4.3 (system audit): the study bbox had been clipped to lat[33.50,34.50]
...
export const KASHMIR_SOURCE_FILES: KashmirSourceFile[] = [
  ...
  // dashboard (user ask — internal detail pack, not for the public download list).
  // The file may still be generated by the engine; it is simply not linked here.
  {
