...
import {
  ...
  type SocialFilter,
  type SortMode,
} from '@/components/rationalization-v3/V3RouteUtils';

type V3RouteTableProps = {
  routes: RationalizedRouteV3[];
  selectedRouteKey: string | null;
  onSelectRoute: (route: RationalizedRouteV3) => void;
};

const PAGE_SIZE = 16;

export default function V3RouteTable({ routes, selectedRouteKey, onSelectRoute }: V3RouteTableProps) {
            ...
            {pagedRoutes.map((route) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm font-black text-cyan-700">{route.headwayMin} min</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    {route.actionTaken !== 'MERGED_INTO_TRUNK' ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1 text-sm font-black text-cyan-700 hover:text-cyan-900"
                      >
